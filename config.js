...
module.exports = {
  owner: {
    ...
    tagline: 'AI-native CPO, ИИ-инфлюенсер. Основатель сообщества vibec0ding.ru. Рассказываю про ИИ, бизнес, продуктовое управление и инвестиции простым языком — для тех, кто только начинает разбираться в финансах.',
    taglineHtml: 'AI-native CPO, ИИ-инфлюенсер. Основатель сообщества vibec<span class="zero">0</span>ding.ru.<br>Рассказываю про ИИ, бизнес, продуктовое управление и инвестиции простым языком — для тех, кто только начинает разбираться в финансах.',
